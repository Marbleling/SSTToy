...
$kaldi/src/latbin/lattice-align-phones --replace-output-symbols=true $exp/tdnn1n_rvb_online/final.mdl "ark:gunzip -c ${dest}/lat.1.gz|" ark:$dest/phone_aligned.lats
